...
<header class="nav">
  <div class="container">
    ...
    <a href="https://apps.shopify.com/ai-catalog-score?ref=blog_q2report" target="_blank" rel="noopener" class="btn btn-sm btn-primary">Install free <span class="btn-arrow">→</span></a>
  </div>
</header>
...
<div class="article-layout">
  ...
  <p>Methodology open at <a href="https://github.com/commerce-agentic/agentic-catalog-scanner">commerce-agentic/agentic-catalog-scanner</a>. Raw dataset README at <a href="https://github.com/commerce-agentic/ai-visibility-metrics">commerce-agentic/ai-visibility-metrics</a>.</p>
    ...
    <div class="cta-section reveal">
      ...
      <a href="https://apps.shopify.com/ai-catalog-score?ref=blog_q2report" target="_blank" rel="noopener" class="btn btn-dark-outline">Install on Shopify</a>
    </div>
  </main>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <div class="stack-12">
          ...
          <a href="/leaderboard/">Leaderboard</a>
          <a href="/blog/">Blog</a>
          <a href="https://apps.shopify.com/ai-catalog-score?ref=blog_q2report" target="_blank" rel="noopener">Install on Shopify</a>
        </div>
      </div>
      <div class="footer-col">
